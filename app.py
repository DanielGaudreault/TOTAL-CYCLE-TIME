...
def upload_files():
    ...
    for excel_file in excel_files:
        ...
        updated_excel_path = os.path.join(app.config['UPLOAD_FOLDER'], f'updated_{excel_file.filename}')
        df.to_excel(updated_excel_path, index=False)

    # Provide download link for the first updated Excel file (for simplicity)
